...
from .serializer import AddTopSellerSerializer, AddKeywordSerializer
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            try:
                ...
                # 关键词不存在
                obj = TopSeller(user=user, title=category, result_file=os.path.join(TOPSELLER_FILE_URL, user.phone, category))
                obj.save()
